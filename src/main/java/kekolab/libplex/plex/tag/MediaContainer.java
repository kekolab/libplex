...
import kekolab.libplex.plex.adapter.IntegerListAdapter;
import kekolab.libplex.plex.adapter.StringListAdapter;
...
public class MediaContainer {
	...
	public List<String> getOwnerFeatures() {
		return ownerFeatures != null ? ownerFeatures : Collections.emptyList();
	}
	...
	public List<Integer> getTranscoderVideoBitrates() {
		return transcoderVideoBitrates != null ? transcoderVideoBitrates : Collections.emptyList();
	}

	public List<Integer> getTranscoderVideoQualities() {
		return transcoderVideoQualities != null ? transcoderVideoQualities : Collections.emptyList();
	}

	public List<Integer> getTranscoderVideoResolutions() {
		return transcoderVideoResolutions != null ? transcoderVideoResolutions : Collections.emptyList();
	}
