...
public class PMSAlbums extends PMSSectionContentContainer {
    ...
    public List<PMSAlbumDirectory> getAlbums() {
        if (albums != null)
    ...
    public void setAlbums(List<PMSAlbumDirectory> albums) {
        this.albums = albums;
    }
}
