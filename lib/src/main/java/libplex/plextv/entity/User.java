...
public class User {
    ...
    @XmlAttribute(name = "mailing_list_status") private String mailingListStatus;
    @XmlAttribute private URL thumb;
    @XmlAttribute private String username;
    @XmlAttribute private String title;
    @XmlAttribute private String cloudSyncDevice;
    @XmlAttribute private String locale;
    @XmlAttribute private String authenticationToken;
    @XmlAttribute private String authToken;
    @XmlAttribute private String scrobbleTypes;
    @XmlAttribute private int restricted;
    @XmlAttribute private int home;
    @XmlAttribute private int guest;
    @XmlAttribute private String queueEmail;
    @XmlAttribute private String queueUid;
    @XmlAttribute private boolean hasPassword;
    @XmlAttribute private int homeSize;
    @XmlAttribute private int maxHomeSize;
    @XmlAttribute private boolean rememberMe;
    @XmlAttribute private int secure;
    @XmlAttribute private int certificateVersion;
...
/*    
    ...
    <user email="coviello.gl@gmail.com" id="15840475" uuid="d6c1f1e826d88d6f" mailing_list_status="unsubscribed" thumb="https://plex.tv/users/d6c1f1e826d88d6f/avatar?c=1558547487" 
    username="gianlucacoviello" title="gianlucacoviello" cloudSyncDevice="" locale="" authenticationToken="-TLuzshzJT_LzpsN1s6d" 
    authToken="-TLuzshzJT_LzpsN1s6d" scrobbleTypes="" restricted="0" home="0" guest="0" queueEmail="queue+96w5tDWy6BUGGTx7PQSr@save.plex.tv" 
    queueUid="" hasPassword="true" homeSize="1" maxHomeSize="15" rememberMe="false" secure="1" certificateVersion="3">
  ...
  <services>
    ...
    <service identifier="graph-dev" endpoint="https://graph-dev.provider.plex.tv" status="online"/>
    <service identifier="graph-staging" endpoint="https://graph-staging.provider.plex.tv" status="online"/>
    <service identifier="metadata" endpoint="https://metadata.provider.plex.tv" token="1vme2aaK6G8fZFtFyKeSmInEvdjpjsHEto45VgX1K0c=" status="online"/>
    <service identifier="metadata-dev" endpoint="https://metadata-dev.provider.plex.tv" token="1vme2aaK6G8fZFtFyKeSmInEvdjpjsHEto45VgX1K0c=" status="online"/>
    ...
    <service identifier="subtitles-search" endpoint="https://metadata.provider.plex.tv/library/metadata/matches" token="1vme2aaK6G8fZFtFyKeSmInEvdjpjsHEto45VgX1K0c=" status="online"/>
    <service identifier="acoustid" endpoint="https://acoustid.plex.tv/" token="XxQtK3u05uaxTaZ6Y6jcrw==" status="online"/>
    <service identifier="lyricfind" endpoint="https://lyricfind.plex.tv/" token="X46ofmSoyOTWjBU4oEx0Rb0ATQjYW31IgFeXw3+/n5hMfGoF7PLEMPrLT9v/zqV1" secret="H8q1AfgeOcf8+wx2ODos1mLBkmsSE4PMCJkkdx27xNwpzzKVV3up6gZJb+teyIOw" status="online"/>
    <service identifier="lyricfind-search" endpoint="https://lyricfind.plex.tv/" token="4HRR+YgScsy+71q8J31KgROAuPkWvsus8XQuVFjYUiTjw5f+LesQ8MAgEcjnuYxW" status="online"/>
    <service identifier="tvdb" endpoint="https://api4.thetvdb.com/" token="CFlmhH676IvrFij0l4BR1YNRtyHjz+9EAH+GU5ZgncfJ3ufdmzWK/3giK1Ovei7u" status="online"/>
  </services>
